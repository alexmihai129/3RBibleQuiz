...
HTMLEscapeMap gAsciiHTMLEscapeMap[] = {
...
HTMLEscapeMap gUnicodeHTMLEscapeMap[] = {
...
- (NSString *)stringByEscapingHTMLUsingTable:(HTMLEscapeMap*)table 
	...
	//require(buffer, cantAllocBuffer);
	unichar *buffer2 = malloc(sizeof(unichar) * length);
	//require(buffer2, cantAllocBuffer2);
...
- (NSString *)stringByUnescapingHTML {
	...
	do {
		...
		unsigned length = (int)[escapeString length];
